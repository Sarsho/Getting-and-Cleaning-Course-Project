...
to github. See assignment description for full details. Data are found here, along with description:  
https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip
http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones
 
Use the following instructions: Please upload the tidy data set created in step 5 of the instructions as a txt file created with write.table() using row.name=FALSE.

The data was downloaded "Mon Feb 22 22:07:05 2016" and extracted without modification of the sub folders, the individual data files were accessed via calls to the sub folders they were extracted.

The script with descriptive commentary is as follows.
